...
public class AdminLogin extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		titleText.setText(Constants.getInstance(getApplicationContext()).adminTitleText);
		...
		emailText.setText(Constants.getInstance(getApplicationContext()).sudoEmailText);
		...
		passwordText.setText(Constants.getInstance(getApplicationContext()).sudoPasswordText);
		...
		adminLogin.setText(Constants.getInstance(getApplicationContext()).loginText);
		...
		adminLogin.setOnClickListener(new OnClickListener() {
			...
			private boolean completeCredentialsPassed() {
				...
				Toast.makeText(getApplicationContext(),
						Constants.getInstance(getApplicationContext()).sudoCredentialsWrongMessage, Toast.LENGTH_LONG)
						.show();
				return false;
			}
		});
